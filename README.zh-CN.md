...
- `voi-ooda-ai-system-evolver/references/evolution-loop-playbook.zh-CN.md`：VOI/OODA 进化闭环。
- `voi-ooda-ai-system-evolver/references/eval-versioning-playbook.zh-CN.md`：eval、trace、版本提升与回滚。
