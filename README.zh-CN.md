...
<table>
  <tr>
    ...
    <td width="33%">
      <img src="./assets/showcase-voi-ooda.png" alt="VOI-OODA AI System Evolver 展示图">
    </td>
  </tr>
  <tr>
...
| Skill | 为什么值得用 | 包目录 |
| --- | --- | --- |
| **VOI-OODA AI System Evolver** | 把 prompt、workflow、memory、schema、RAG、tool routing 和 eval 的改动，变成受控的系统演化。它会判断什么信息值得获取，让 agent 持续校准现实，对高影响改动设置 Human Gate，并让升级可以 rollback。 | [`voi-ooda-ai-system-evolver/`](./voi-ooda-ai-system-evolver/) |
